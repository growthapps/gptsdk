...
* GitHub Issues: <https://github.com/gptsdk/gptsdk-library/issues>
...
* gptsdk/gptsdk-library follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  gptsdk/gptsdk-library automatically runs tests for pull requests. However,
...
[github]: https://github.com/gptsdk/gptsdk-library
[issues]: https://github.com/gptsdk/gptsdk-library/issues
[pull requests]: https://github.com/gptsdk/gptsdk-library/pulls
